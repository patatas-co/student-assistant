...
<body>
    ...
    <main>
        <section id="hero" class="page-wrapper hero">
            <div class="hero-copy">
                <p class="eyebrow">Research Capstone Highlight</p>
                <h1>
                    Development of <span>Web-based System</span> for Student Assistant Application &amp; Streamlined Support Services
                </h1>
                <p>
                    A unified digital platform that modernizes student assistant recruitment, automates compliance workflows, and centralizes student support delivery for a data-informed campus experience.
                </p>
